"""Modelos SQLAlchemy — mapeiam DICIONARIO_DE_DADOS.md + adaptações da
Sprint 3 aos dados reais (docs/DECISIONS.md, seção 13).
...
from app.infrastructure.models.carteira_avert_model import CarteiraAvert
...
from app.infrastructure.models.cliente_integracao_model import ClienteIntegracao
from app.infrastructure.models.cliente_model import Cliente
from app.infrastructure.models.cliente_vendedor_model import ClienteVendedor
...
from app.infrastructure.models.tipo_promotor_model import TipoPromotorCadastro
...
from app.infrastructure.models.visita_produto_sb_model import VisitaProdutoSb
from app.infrastructure.models.visita_resumo_sb_model import VisitaResumoSb
